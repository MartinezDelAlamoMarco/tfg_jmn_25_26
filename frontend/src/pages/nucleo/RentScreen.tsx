  ...
  const handleGetAdvertisements = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        const rentals = res.data.filter(
          (ad: any) =>
            ad.is_rent === true || ad.is_rent === 1 || ad.is_rent === "1",
        );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredAds.map((v) => {
            ...
            return (
              <div
                key={v.id}
                className="bg-zinc-800 rounded-xl p-6 border border-zinc-700 flex flex-col hover:shadow-2xl hover:border-red-700 transition duration-300 group"
              >
