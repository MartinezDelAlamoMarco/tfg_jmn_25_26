        ...
        <div className="bg-zinc-800 rounded-2xl p-6 mb-12 border border-zinc-700 shadow-2xl">
          ...
          {showAdvancedFilters && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4 border-t border-zinc-700 animate-in slide-in-from-top-2">
              <input type="number" name="minPrice" placeholder="Precio Min (€/día)" value={filters.minPrice} onChange={handleFilterChange} className="w-full px-4 py-2 bg-zinc-900 border border-zinc-600 rounded-lg text-white outline-none" />
              <input type="number" name="maxPrice" placeholder="Precio Max (€/día)" value={filters.maxPrice} onChange={handleFilterChange} className="w-full px-4 py-2 bg-zinc-900 border border-zinc-600 rounded-lg text-white outline-none" />
            ...
            return (
              <div key={v.id} className="bg-zinc-800 rounded-xl p-6 border border-zinc-700 flex flex-col hover:shadow-2xl hover:border-red-700 transition duration-300 group">
                ...
                <div className="flex flex-col gap-1 mb-6 mt-auto">
                  <p className="text-xs text-zinc-400">{v.year} • {v.km} km • {v.fuel_type_name} • {v.province_name}</p>
