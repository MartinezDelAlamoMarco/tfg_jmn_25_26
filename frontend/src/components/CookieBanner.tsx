        ...
        <div className="flex items-start gap-4 flex-1">
          ...
          <div>
            <h3 className="text-white font-bold mb-1">
              {t("cookie_banner.title", "Valoramos tu privacidad")}
            </h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              {t(
                "cookie_banner.message",
                'Utilizamos cookies propias y de terceros para gestionar la sesión, analizar la navegación y mejorar la experiencia en nuestra plataforma. Al hacer clic en "Aceptar todas", consientes su uso.',
              )}{" "}
              <Link
                to="/politica-cookies"
                className="text-red-500 hover:text-red-400 underline underline-offset-2 transition-colors whitespace-nowrap"
              >
