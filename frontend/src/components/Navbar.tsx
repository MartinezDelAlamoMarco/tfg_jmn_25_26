    ...
    <nav className="w-full bg-zinc-900 text-white border-b border-zinc-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Search Bar - Center (Oculto en móvil) */}
          ...
          <div className="px-4 pt-4 space-y-5">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Buscar vehículos..."
                className="w-full pl-10 pr-4 py-2.5 bg-zinc-800/50 border border-zinc-700 rounded-xl text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent transition duration-200"
              />
            </div>
